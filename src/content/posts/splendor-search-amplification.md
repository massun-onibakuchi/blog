...
pair score は0.5なら互角で、それより高ければ左側の設定が強い。
...
面白いのは、実効探索量が想定よりかなり小さかったにもかかわらず、それでも探索の強さの増幅は大きかったことだ。
...
今回の一番大きな収穫は、探索と学習をまとめて「強くならない」と見るのではなく、探索部分だけを切り出して測れたことだった。探索そのものはかなり仕事をしている。次は、その出力を学習側が取り込めているかを調べる。

---

※ 本記事は、実験ログ・コード・計測結果をもとに、AI と共同編集して構成・執筆した。
